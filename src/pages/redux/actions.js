...
export const donationApi = async (data) => {
  const endpoint = "https://1608-34-170-249-201.ngrok-free.app/givesome/api/payment/create";
  try {
...
export const rewardApplyApi = async (data) => {
  ...
  const endpoint = `https://1608-34-170-249-201.ngrok-free.app/givesome/api/payment/givecard`;
  try {
      const response = await axios.post(`${endpoint}`, data);
    //   const response = {
    //    data: {
...
export const redeemGivecardApi = async (data) => {
  ...
  const endpoint = `https://1608-34-170-249-201.ngrok-free.app/givesome/api/payment/givecard/redeem`;
  try {
      const response = await axios.post(`${endpoint}`, data);
    //   const response = {
    //    data: {
...
export const getCurrencyList = async (data) => {
  ...
  const endpoint = `https://1608-34-170-249-201.ngrok-free.app/givesome/api/payment/currency/list`;
  try {
