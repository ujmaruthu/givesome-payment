...
export const donationApi = async (data) => {
  const endpoint = "https://qa-api.givesome.gives/givesome/api/payment/create";
  try {
...
export const rewardApplyApi = async (data) => {
  ...
  const endpoint = `https://qa-api.givesome.gives/givesome/api/payment/givecard`;
  try {
      const response = await axios.post(`${endpoint}`, data);
    //   const response = {
    //    data: {
...
export const redeemGivecardApi = async (data) => {
  ...
  const endpoint = `https://qa-api.givesome.gives/givesome/api/payment/givecard/redeem`;
  try {
      const response = await axios.post(`${endpoint}`, data);
    //   const response = {
    //    data: {
...
export const getCurrencyList = async (data) => {
  ...
  const endpoint = `https://qa-api.givesome.gives/givesome/api/payment/currency/list`;
  try {
